...
env = environ.Env(
    ...
    TG_API_ID=(str),
    TG_API_HASH=(str),
    RBKASSA_MERCHANT_LOGIN=(str),
    RBKASSA_PASSWORD_1=(str),
    RBKASSA_PASSWORD_2=(str),
)
...
# Настройка времени жизни пользовательской сессии(указ. в секундах)
...
# Настройки для платежей через robokassa
RBKASSA_MERCHANT_LOGIN = env('RBKASSA_MERCHANT_LOGIN')
RBKASSA_PASSWORD_1 = env('RBKASSA_PASSWORD_1')
RBKASSA_PASSWORD_2 = env('RBKASSA_PASSWORD_2')
